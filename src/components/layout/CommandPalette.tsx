...
import { BookOpen, Code, Cards, Key, NotePencil, Bell, Compass, IdentificationCard } from '@phosphor-icons/react'
          ...
          <Command.List className="max-h-80 overflow-y-auto p-2">
            {!query && (
              <Command.Group heading="Quick navigation">
                ...
                <CommandItem icon={Compass} onSelect={() => go('/planner')}>
                  Planner
                </CommandItem>
                <CommandItem icon={IdentificationCard} onSelect={() => go('/accounts')}>
                  Accounts
                </CommandItem>
